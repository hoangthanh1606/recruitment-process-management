...
const publicRoutes = [
  {
    ...
    exact: true,
    component: lazy(() => import('@iso/containers/ListCP/ViewListCP')),
  },
  {
  ...
  {
    path: PUBLIC_ROUTE.APPLY_CAMPAIGN,
    component: lazy(() =>
      import('@iso/containers/Candidate/ApplyCampaign/ApplyCampaign')
    ),
  },
  {
    path: PUBLIC_ROUTE.CAMPAIGN_DETAILS,
    component: lazy(() =>
      import('@iso/containers/Candidate/CampaignDetail')
    ),
  },
  {
    path: PUBLIC_ROUTE.THANKS,
    component: lazy(() =>
      import('@iso/containers/Pages/Thanks/Thanks')
    ),
  },
];
