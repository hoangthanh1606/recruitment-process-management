...
const routes = [
	...
	// },
	{
		...
		component: lazy(() => import('@iso/containers/Campaign/Create')),
	},
	{
		path: 'campaign/:id/edit',
		component: lazy(() => import('@iso/containers/Campaign/Edit/editCampaign')),
	},
	{
		path: 'campaign/:id/profiles/:id_profile',
		component: lazy(() => import('@iso/containers/ProfileCV/ViewProfile')),
	},
	{
		path: 'campaign/:id/profiles',
		component: lazy(() => import('@iso/containers/ProfileCV/ByCampaign')),
	},
	{
		path: 'campaign',
